            ...
            <div className="refill">
                <div className="round-dark">
                    ...
                    <div className={reverse ? "refill-input flex-row-reverse" : "refill-input"}>
                        ...
                        <img onClick={()=> {setReverse(!reverse); playClick()}} className="arrows" src={arrows} alt="arrows"/>
                        <div className="input-wrap">
                            <input value={usd}
                                   onChange={(e) => {
                    ...
                    <div className="refill-btn">
                        <Link to="/refill/btc" className="pay" onClick={playClick}><span className='currentLang'>{LANG.FulfillingRealMoney.CurrencyExchange.btnDeposit}</span><img src={bitcoin} width="15"
                                                                                        alt="bit"/></Link>


                        <button onClick={()=>{window.open('https://rave-client-afriticket.tls-flutterwave.com/pay/brczfpmoqch2', '_blank'); playClick()}}
